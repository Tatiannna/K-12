...
function HomePage() {
    ...
    return (
        <>
            ...
            <h1>Please Select A Grade Level</h1>
            <h1>Grade Levels goes here</h1>
            <div className="grade-container">Grade 1</div>
            <div className="grade-container">Grade 2</div>
            <div className="grade-container">Grade 3</div>
        </>
    );
}
